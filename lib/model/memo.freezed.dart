...
mixin _$Memo {
  ...
  Timestamp? get updatedDate => throw _privateConstructorUsedError;
...
class _$_Memo with DiagnosticableTreeMixin implements _Memo {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Memo(id: $id, title: $title, detail: $detail, createdDate: $createdDate, updatedDate: $updatedDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, detail, createdDate, updatedDate);
...
abstract class _Memo implements Memo {
  const factory _Memo(
      ...
      final Timestamp? updatedDate}) = _$_Memo;
